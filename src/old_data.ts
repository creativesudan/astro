...
import { useKundli } from './kundliContext';
    ...
    <div className='kundli'>
      ...
      <div className='headerHouses'>
        <div className='topLeft corner_house'>
          <a href='#0' className='topHouse houses'>
            <div className='inner'>
              <div className='data'>
                <div className='rashi'>{kundli.house_2.rashi}</div>
                <span className='planets'>
                  {kundli.house_2?.planets?.map(e => {
                    const planetName = planets.find(p => p.no === e.no)?.name || e.name;
                    return planetName + ', ';
                  })}
                </span>
                <div className='house_num'>2</div>
              </div>
            </div>
          </a>
          <a href='#0' className='leftHouse houses'>
            <div className='inner'>
              <div className='data'>
                <div className='rashi'>{kundli.house_3.rashi}</div>
                <span className='planets'>
                {kundli.house_3?.planets?.map(e => {
                  const planetName = planets.find(p => p.no === e.no)?.name || e.name;
                  return planetName + ', ';
                })}
                </span>
                <div className='house_num'>3</div>
              </div>
            </div>
          </a>
        </div>
        ...
        <div className='topRight corner_house'>
          <a href='#0' className='rightHouse houses'>
            <div className='inner'>
              <div className='data'>
                <div className='rashi'>{kundli.house_11.rashi}</div>
                <span className='planets'>
                {kundli.house_11?.planets?.map(e => {
                    const planetName = planets.find(p => p.no === e.no)?.name || e.name;
                    return planetName + ', ';
                  })}
                </span>
                <div className='house_num'>11</div>
              </div>
            </div>
          </a>
          <a href='#0' className='topHouse houses'>
            <div className='inner'>
              <div className='data'>
                <div className='rashi'>{kundli.house_12.rashi}</div>
                <span className='planets'>
                {kundli.house_12?.planets?.map(e => {
                  const planetName = planets.find(p => p.no === e.no)?.name || e.name;
                  return planetName + ', ';
                })}
                </span>
                <div className='house_num'>12</div>
              </div>
            </div>
          </a>
        </div>
      ...
      <div className='center_houses'>
        <a href='#0' className='center_4 houses'>
          <div className='inner'>
            <div className='data'>
              <div className='rashi'>{kundli.house_1.rashi}</div>
              <span className='planets'>
              {kundli.house_1?.planets?.map(e => {
                const planetName = planets.find(p => p.no === e.no)?.name || e.name;
                return planetName + ', ';
              })}
              </span>
              <div className='house_num'>1</div>
            </div>
          </div>
        </a>
        <a href='#0' className='center_4 houses'>
          <div className='inner'>
            <div className='data'>
              <div className='rashi'>{kundli.house_10.rashi}</div>
              <span className='planets'>
              {kundli.house_10?.planets?.map(e => {
                const planetName = planets.find(p => p.no === e.no)?.name || e.name;
                return planetName + ', ';
              })}
              </span>
              <div className='house_num'>10</div>
            </div>
          </div>
        </a>
        <a href='#0' className='center_4 houses'>
          <div className='inner'>
            <div className='data'>
              <div className='rashi'>{kundli.house_4.rashi}</div>
              <span className='planets'>
              {kundli.house_4?.planets?.map(e => {
                const planetName = planets.find(p => p.no === e.no)?.name || e.name;
                return planetName + ', ';
              })}
              </span>
              <div className='house_num'>4</div>
            </div>
          </div>
        </a>
        <a href='#0' className='center_4 houses'>
          <div className='inner'>
            <div className='data'>
              <div className='rashi'>{kundli.house_7.rashi}</div>
              <span className='planets'>
              {kundli.house_7?.planets?.map(e => {
                const planetName = planets.find(p => p.no === e.no)?.name || e.name;
                return planetName + ', ';
              })}
              </span>
              <div className='house_num'>7</div>
            </div>
          </div>
        </a>
      </div>
      ...
      <div className='footerHouses'>
        <div className='bottomLeft corner_house'>
          <a href='#0' className='bottomHouse houses'>
            <div className='inner'>
              <div className='data'>
                <div className='rashi'>{kundli.house_6.rashi}</div>
                <span className='planets'>
                {kundli.house_6?.planets?.map(e => {
                    const planetName = planets.find(p => p.no === e.no)?.name || e.name;
                    return planetName + ', ';
                  })}
                </span>
                <div className='house_num'>6</div>
              </div>
            </div>
          </a>
          <a href='#0' className='leftHouse houses'>
            <div className='inner'>
              <div className='data'>
                <div className='rashi'>{kundli.house_5.rashi}</div>
                <span className='planets'>
                {kundli.house_5?.planets?.map(e => {
                  const planetName = planets.find(p => p.no === e.no)?.name || e.name;
                  return planetName + ', ';
                })}
                </span>
                <div className='house_num'>5</div>
              </div>
            </div>
          </a>
        </div>
        ...
        <div className='bottomRight corner_house'>
          <a href='#0' className='rightHouse houses'>
            <div className='inner'>
              <div className='data'>
                <div className='rashi'>{kundli.house_9.rashi}</div>
                <span className='planets'>
                {kundli.house_9?.planets?.map(e => {
                  const planetName = planets.find(p => p.no === e.no)?.name || e.name;
                  return planetName + ', ';
                })}
                </span>
                <div className='house_num'>9</div>
              </div>
            </div>
          </a>
          <a href='#0' className='bottomHouse houses'>
            <div className='inner'>
              <div className='data'>
                <div className='rashi'>{kundli.house_8.rashi}</div>
                <span className='planets'>
                {kundli.house_8?.planets?.map(e => {
                  const planetName = planets.find(p => p.no === e.no)?.name || e.name;
                  return planetName + ', ';
                })}
                </span>
                <div className='house_num'>8</div>
              </div>
            </div>
          </a>
        </div>
